...
public class day_7_exer5 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day7_exer5);
        getSupportActionBar().setTitle("Day 7");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        btnFinish = findViewById(R.id.d7_btn_finish1);
    ...
    public void onClick(View v) {
        int btn_id = v.getId();
        if(btn_id == R.id.d7_btn_back5){
            startActivity(new Intent(day_7_exer5.this, day_7_exer4.class));
