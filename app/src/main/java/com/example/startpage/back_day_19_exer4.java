...
public class back_day_19_exer4 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_back_day19_exer4);
        getSupportActionBar().setTitle("Day 19");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        btnFinish = findViewById(R.id.back_d19_btn_finish);
    ...
    public void onClick(View v) {
        if(v == btnBack){
            startActivity(new Intent(back_day_19_exer4.this, back_day_19_exer3.class));
