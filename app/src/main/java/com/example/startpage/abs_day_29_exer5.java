...
public class abs_day_29_exer5 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abs_day29_exer5);
        getSupportActionBar().setTitle("Day 29");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        btn_next = findViewById(R.id.abs_d29_btn_finish1);
    ...
    public void onClick(View v) {
        if(v == btnBack){
            startActivity(new Intent(abs_day_29_exer5.this, abs_day_29_exer4.class));
