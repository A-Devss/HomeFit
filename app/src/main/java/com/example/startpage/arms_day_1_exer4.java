...
public class arms_day_1_exer4 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back4 = findViewById(R.id.arms_d1_btn_back4);
    ...
    public void onClick(View v) {
        if(v == btn_back4){
            ...
            startActivity(new Intent(arms_day_1_exer4.this, arms_day_1_exer5.class));
            overridePendingTransition(0, 0);
        }
    }
    @Override
