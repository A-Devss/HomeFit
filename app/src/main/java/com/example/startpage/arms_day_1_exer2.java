...
public class arms_day_1_exer2 extends AppCompatActivity implements View.OnClickListener{
    private Button btn_next2;
    private TextView btn_back2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_arms_day1_exer2);
        getSupportActionBar().setTitle("Day 1");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        btn_next2 = findViewById(R.id.arms_d1_btn_next2);
        btn_next2.setOnClickListener(this);
        btn_back2 = findViewById(R.id.arms_d1_btn_back2);
    ...
    public void onClick(View v) {
        if(v == btn_back2){
            ...
            startActivity(new Intent(arms_day_1_exer2.this, arms_day_1_exer3.class));
            overridePendingTransition(0, 0);
        }
    }
    @Override
