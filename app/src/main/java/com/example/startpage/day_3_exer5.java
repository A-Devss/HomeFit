...
public class day_3_exer5 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day3_exer5);
        getSupportActionBar().setTitle("Day 3");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        btnFinish = findViewById(R.id.d3_btn_finish1);
    ...
    public void onClick(View v) {
        int btn_id = v.getId();
        if(btn_id == R.id.d3_btn_back5){
            startActivity(new Intent(day_3_exer5.this, day_3_exer4.class));
