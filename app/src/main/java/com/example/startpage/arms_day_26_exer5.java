...
public class arms_day_26_exer5 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arms_day26_exer5);
        getSupportActionBar().setTitle("Day 26");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        btnFinish = findViewById(R.id.arms_d26_btn_finish1);
    ...
    public void onClick(View v) {
        if(v == btn_back2){
            startActivity(new Intent(arms_day_26_exer5.this, arms_day_26_exer4.class));
